...
for (var i = 0; i < people.length; i++) {
    ...
    newLi.innerHTML = `ID: ${people[i].id} <br> Name: ${people[i].name} <br> Gender: ${people[i].gender} <br> Age:
    ${people[i].age} <br> Eye Color: ${people[i].eye_color} <br> Hair Color: ${people[i].hair_color} <br> Films: ${people[i].films} <br> Species: ${people[i].species} <br> URL: ${people[i].url}`
