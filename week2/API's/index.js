...
for (var i = 0; i < text.length; i++) {
    ...
    div.innerHTML = `ID: ${text[i].id} <br> Name: ${text[i].name} <br> Classification: ${text[i].classification} <br> Eye Colors: ${text[i].eye_colors} <br> Hair Colors: ${text[i].hair_colors } <br> URL: ${text[i].url} <br> People: ${text[i].people} <br> Films: ${text[i].films}`
